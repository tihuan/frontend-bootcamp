# Self-guided Frontend Bootcamp 🥾⛺️✨

## Welcome

This project is forked from [here](https://github.com/microsoft/frontend-bootcamp) and is intended to provide a self-guided learning experience for any engineer who wants to ramp up on frontend development.

At the end of this course, we hope to equip you with enough knowledge and tools to feel confident and comfortable working on any frontend feature.

The first section provides an introduction to the fundamentals of the web: HTML, CSS and JavaScript. This is targeted at new and experienced developers alike.

The second section dives into more advanced topics like TypeScript, state management, and testing. While the examples should be accessible to anyone, you'll get the most out of it if you have some prior experience with programming and web technologies.
...
- [Node/NPM](https://nodejs.org/en/) (download and install the **LTS** option. Note: you might need to right click on the `.pkg` file and click "open", otherwise macOS will not let you install)
